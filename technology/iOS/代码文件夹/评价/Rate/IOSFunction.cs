...
public class IOSFunction
{
    ...
    public static void SetLocalization (string title , string message , string cancel , string gorate)
    {
        #if UNITY_EDITOR
        return;
        #endif
        _SetLocalization(title, message, cancel, gorate);
    }


    [DllImport("__Internal")]
    static extern void _SetLocalization (string title , string message , string cancel , string gorate);
