...
- (void)reachabilityChanged:(NSNotification *)note
{
    ...
    switch (status)
    {
        ...
        case NotReachable:
            NSLog(@"网络类型No net");
            UnitySendMessage("TJSDK", "netTypeResult", "No net");
            break;
            
        case ReachableViaWiFi:
             NSLog(@"网络类型WiFi");
            UnitySendMessage("TJSDK", "netTypeResult", "WiFi");
            break;
        case ReachableViaWWAN:
             NSLog(@"网络类型WWAN");
            UnitySendMessage("TJSDK", "netTypeResult", "WWAN");
            break;
            
        case kReachableVia2G:
             NSLog(@"网络类型2G");
            UnitySendMessage("TJSDK", "netTypeResult", "2G");
            break;
            
        case kReachableVia3G:
             NSLog(@"网络类型3G");
            UnitySendMessage("TJSDK", "netTypeResult", "3G");
            break;
            
        case kReachableVia4G:
             NSLog(@"网络类型4G");
            UnitySendMessage("TJSDK", "netTypeResult", "4G");
            break;
    }
    [self dealloc];
}
...
void _getNetType(){
    //设置状态栏
   U3dInteractive *Net = [[U3dInteractive alloc]init];
    [Net checkNetType];

//    const char* sb = "jjj";
//    return MakeStringCopy(sb);
}
...
//    //手机型号
//    NSString* phoneModel = [U3dInteractive iphoneType];
//    const char*idfa         = [adId UTF8String];
//    const char*resolve   = [resolution UTF8String];
//    const char*phoneVer = [phoneVersion UTF8String];
//    const char*phoneType   = [phoneModel UTF8String];
//    callback(idfa,resolve,phoneVer,phoneType);
//}