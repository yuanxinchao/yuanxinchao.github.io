...
namespace ConsoleApplication1
{
    public class DailyInfo
    {
        ...
        private List<IObserverDaily> _observer = new List<IObserverDaily>();

        public void Attach(IObserverDaily observerCaptain)
        {
            _observer.Add(observerCaptain);
        }

        public void Detach(IObserverDaily observerCaptain)
        {
